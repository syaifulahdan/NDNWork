...
main(int argc, char* argv[])
{
  ...
  p2p.Install(nodes.Get(50), nodes.Get(53)); //banjarmasin -> tanahgrogot
  ...
  p2p.Install(nodes.Get(73), nodes.Get(74)); //tahuna -> bandaseaopt4
  ...
  p2p.Install(nodes.Get(133), nodes.Get(132)); //enorotali -> timika 
...
// Installing applications
  ...
  consumerHelper.Install(nodes.Get(2));                        // bandarlampung
 
  consumerHelper.SetPrefix("/prefix");
  consumerHelper.SetAttribute("Frequency", StringValue("100")); // 10 interests a second
  consumerHelper.Install(nodes.Get(7));                        // kupang
  ...
  producerHelper.Install(nodes.Get(11)); // surabaya
 ...
 //Producer will reply to all requests starting with /prefix
  ...
  //producerHelper.SetAttribute("PayloadSize", StringValue("1024"));
  //producerHelper.Install(nodes.Get(31)); // sabang

// Calculate and install FIBs
  GlobalRoutingHelper::CalculateRoutes();

  ndn::AppDelayTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-thesis/Delay-differentstrategy-ncc.txt");
  L2RateTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-thesis/L2-differentstrategy-ncc.txt");
  ndn::L3RateTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-thesis/L3-differentstrategy-ncc.txt");
