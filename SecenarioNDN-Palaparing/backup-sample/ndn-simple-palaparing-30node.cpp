...
main(int argc, char* argv[])
{
  ...
  consumerHelper.Install(nodes.Get(44)); // consumerA15-banyuwangi
  consumerHelper.Install(nodes.Get(51)); // consumerA16-tarempa
  consumerHelper.Install(nodes.Get(66)); // consumerA17-manado
  consumerHelper.Install(nodes.Get(78)); // consumerA18-baubau
  consumerHelper.Install(nodes.Get(81)); // consumerA19-parepare
  consumerHelper.Install(nodes.Get(18)); // consumerA20-pekanbaru
  consumerHelper.Install(nodes.Get(93)); // consumerA21-pulaumorotai
  consumerHelper.Install(nodes.Get(118)); // consumerA22-pulauanum
  consumerHelper.Install(nodes.Get(140)); // consumerA23-ilaga
  consumerHelper.Install(nodes.Get(24)); // consumerA24-pulaubelitung
  consumerHelper.Install(nodes.Get(34)); // consumerA25-semarang
  consumerHelper.Install(nodes.Get(84)); // consumerA26-ambon
  consumerHelper.Install(nodes.Get(104)); // consumerA27-seba
  consumerHelper.Install(nodes.Get(144)); // consumerA28-tanahmerah
  consumerHelper.Install(nodes.Get(83)); // consumerA29-makasar
  consumerHelper.Install(nodes.Get(23)); // consumerA30-pulaubangka
  // Producer
  ...
  ndn::AppDelayTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-inherent/Delay-palaparing-multicast-500s.txt");
  //L2RateTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-inherent/L2-palaparing-multicast-100s.txt");
  //ndn::L3RateTracer::InstallAll("/home/bertopeng17/ndnSIM/ns-3/data-tracer-inherent/L3-palaparing-multicast-100s.txt");
